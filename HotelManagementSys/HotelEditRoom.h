...
namespace HotelManagementSys {
	...
	/// <summary>
	/// Summary for HotelEditRoom
	/// </summary>
	public ref class HotelEditRoom : public System::Windows::Forms::Form
	{
	public: UserData^ userdata1 = nullptr;
	public:
		HotelEditRoom(UserData^ userdata)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(HotelEditRoom::typeid));
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(460, 445);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(112, 29);
			this->button1->TabIndex = 57;
			this->button1->Text = L"Update Room";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &HotelEditRoom::button1_Click);
			// 
			// button4
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &HotelEditRoom::button4_Click);
			// 
			// label1
			// 
			...
			this->label1->Size = System::Drawing::Size(712, 80);
			this->label1->TabIndex = 55;
			this->label1->Text = L"Update / Delete Room";
			// 
			// textBox3
			// 
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(588, 445);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(112, 29);
			this->button2->TabIndex = 60;
			this->button2->Text = L"Delete Room";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &HotelEditRoom::button2_Click);
			// 
			// button3
			// 
			this->button3->Location = System::Drawing::Point(718, 199);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(57, 37);
			this->button3->TabIndex = 61;
			this->button3->Text = L"Go";
			this->button3->UseVisualStyleBackColor = true;
			this->button3->Click += gcnew System::EventHandler(this, &HotelEditRoom::button3_Click);
			// 
			// HotelEditRoom
			// 
			...
			this->Name = L"HotelEditRoom";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Hotel Management System - Edit Room";
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		try
		{
			MySqlCommand^ cmd = gcnew MySqlCommand(" UPDATE `roomdetails` SET `roomType`='"+type+"',`acornonac`='"+acnonac+"',`roomRent`="+rent+" WHERE `roomNo` = " + ((userdata1->hotelId * pow(10, ((trunc(log10(roomno))) + 1))) + roomno) + "", con);
			MySqlDataReader^ dr;
			con->Open();
			dr = cmd->ExecuteReader();
			MessageBox::Show("Room updated sucsessfully");
			con->Close();
		}
		catch (Exception^ ex)
		{
	...
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		{
			int roomno = Int32::Parse(textBox1->Text);
			MySqlCommand^ cmd = gcnew MySqlCommand("DELETE FROM `roomdetails` WHERE `roomNo` = " + ((userdata1->hotelId * pow(10, ((trunc(log10(roomno))) + 1))) + roomno) + "", con);
			MySqlDataReader^ dr;
			con->Open();
			dr = cmd->ExecuteReader();
