...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Click += gcnew System::EventHandler(this, &CustomerLogin::button2_Click);
			// 
			// button1
			// 
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Microsoft YaHei UI", 36, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label1->Location = System::Drawing::Point(298, 49);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(513, 80);
			this->label1->TabIndex = 18;
			this->label1->Text = L"Customer Login";
			// 
			// label4
			// 
			this->label4->AutoSize = true;
			this->label4->Location = System::Drawing::Point(491, 482);
			...
			this->button3->Click += gcnew System::EventHandler(this, &CustomerLogin::button3_Click);
			// 
			// CustomerLogin
			// 
			...
			this->Text = L"Hotel Management System - Customer Login";
			this->ResumeLayout(false);
			this->PerformLayout();

		}
#pragma endregion
	public: int custlogsel = 0;
	public: CustomerData^ custdata = nullptr;
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		try {
			...
			if (dr->Read())
			{
				custdata = gcnew CustomerData;
				custdata->userId = dr->GetInt32(0);
				custdata->username = dr->GetString(1);
				custdata->fullName = dr->GetString(2);
				custdata->emailId = dr->GetString(3);
				custdata->phone = dr->GetString(4);
				custdata->password = dr->GetString(5);
