...
namespace HotelManagementSys {
	...
	public:
		Admin(AdminData^ admindata)
		{
			...
			//
			label2->Text = "Welcome " + admindata->name;
		}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(443, 9);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(235, 80);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(338, 243);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(132, 74);
			this->button1->TabIndex = 7;
			this->button1->Text = L"Manage Hotel Owners";
			...
			this->button2->Location = System::Drawing::Point(634, 243);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(132, 74);
			this->button2->TabIndex = 8;
			this->button2->Text = L"Manage Users";
			...
			this->Text = L"Hotel Management System - Admin Dashboard";
